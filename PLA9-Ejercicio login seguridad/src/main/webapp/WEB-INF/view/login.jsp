...
<html>
	...
	<body>
		...
		<form:form action="${pageContext.request.contextPath}/authenticateTheUser" method="POST">
			...
			<input onclick="window.location.href = '${pageContext.request.contextPath}/index-login';" type="submit" value="Login" class="btn btn-primary" />
		</form:form>
			<br />	
					<a href="${pageContext.request.contextPath}/"
			class="btn btn-outline-primary">PÁGINA PRINCIPAL</a>
